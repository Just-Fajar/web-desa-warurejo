            ...
            <div class="bg-white rounded-3xl shadow-sm border border-gray-100 overflow-hidden">
                <div class="p-6 space-y-6">
                    ...
                    <div>
                        ...
                        <input type="text" name="slug" id="slug" value="{{ old('slug', $potensi->slug) }}"
                    ...
                    <div>
                        ...
                        <textarea id="deskripsi" name="deskripsi" rows="15" class="w-full px-5 py-3 bg-gray-50 border border-gray-100 rounded-xl focus:ring-2 focus:ring-primary-500 focus:border-primary-500 focus:bg-white transition-all text-sm font-medium @error('deskripsi') border-red-300 ring-red-100 @enderror">{{ old('deskripsi', $potensi->deskripsi) }}</textarea>
                        ...
                        <div>
                            ...
                            <div class="border-2 border-dashed border-gray-300 rounded-xl p-6 text-center relative hover:border-primary-500 transition cursor-pointer flex flex-col justify-center h-48">
                                ...
                                <div>
                                    ...
                                    <h3 class="text-primary-600 hover:text-primary-700 font-semibold text-sm">Tambah Foto Galeri</h3>
                    ...
                    @if($potensi && $potensi->fotoGaleri && $potensi->fotoGaleri->count() > 0)
                    <div>
                        <h4 class="text-sm font-bold text-gray-700 mb-2">Foto Galeri Saat Ini</h4>
                        <div class="grid grid-cols-2 md:grid-cols-4 gap-4" id="existingGaleri">
                ...
                <div class="px-6 py-4 bg-gray-50 border-t border-gray-200 flex justify-between items-center">
                    ...
                    <button type="submit" id="submitBtn"
                        ...
                        <span id="submitBtnText" data-module="Potensi">Update Potensi</span>
                    </button>
                </div>
            </div>
        </form>
