                        ...
                        <div class="col-md-8">
                            ...
                            <div class="mb-4">
                                ...
                                <input type="text" id="nama" name="nama" value="{{ old('nama') }}"
                                    placeholder="Contoh: Pertanian Padi Organik" required class="w-full px-5 py-3 bg-gray-50 border border-gray-100 rounded-xl focus:ring-2 focus:ring-primary-500 focus:border-primary-500 focus:bg-white transition-all text-sm font-medium
                      @error('nama') border-red-300 ring-red-100 @enderror">
                         ...
                         @error('deskripsi_singkat') border-red-300 ring-red-100 @enderror">{{ old('deskripsi_singkat') }}</textarea>
                            ...
                            <div class="mb-4">
                                ...
                                <textarea id="deskripsi" name="deskripsi" rows="15" class="w-full px-5 py-3 bg-gray-50 border border-gray-100 rounded-xl focus:ring-2 focus:ring-primary-500 focus:border-primary-500 focus:bg-white transition-all text-sm font-medium
                         @error('deskripsi') border-red-300 ring-red-100 @enderror">{{ old('deskripsi') }}</textarea>
                            ...
                            <div class="col-md-4">
                                ...
                                <div class="mb-4">
                                    ...
                                    <!-- Image Preview -->
                                    <div id="imagePreview" class="mt-3" style="
                display: none;
                border-radius: 8px;
                overflow: hidden;
            ...
            ">
                                ...
                                <div class="mb-4">
                                    ...
                                    <select
                                        ...
                                        <option value="peternakan" {{ old('kategori') == 'peternakan' ? 'selected' : '' }}>
                                            Peternakan</option>
                                        <option value="perikanan" {{ old('kategori') == 'perikanan' ? 'selected' : '' }}>
                                            Perikanan</option>
                                ...
                                <div class="mb-4">
                                    ...
                                    <input type="text" id="lokasi" name="lokasi" value="{{ old('lokasi') }}"
                                        placeholder="Contoh: Dusun Krajan" required class="w-full px-5 py-3 bg-gray-50 border border-gray-100 rounded-xl focus:ring-2 focus:ring-primary-500 focus:border-primary-500 focus:bg-white transition-all text-sm font-medium
                      @error('lokasi') border-red-300 ring-red-100 @enderror">
                                ...
                                <div class="mb-4">
                                    ...
                                    <input type="email" id="kontak" name="kontak" value="{{ old('kontak') }}"
                                        placeholder="Contoh: warurejo@gmail.com" class="w-full px-5 py-3 bg-gray-50 border border-gray-100 rounded-xl focus:ring-2 focus:ring-primary-500 focus:border-primary-500 focus:bg-white transition-all text-sm font-medium
                      @error('kontak') border-red-300 ring-red-100 @enderror">
                                ...
                                <div class="mb-4">
                                    ...
                                    <div class="flex relative">
                                        <span
                                            class="inline-flex items-center px-4 rounded-l-xl border border-r-0 border-gray-100 bg-gray-50 text-gray-500 font-medium sm:text-sm">
                                            +62
                                        </span>
                                        <input type="text" id="whatsapp" name="whatsapp" value="{{ old('whatsapp') }}"
                                            placeholder="8123456789" maxlength="15" pattern="[0-9]*" class="flex-1 min-w-0 block w-full px-5 py-3 bg-gray-50 border border-gray-100 rounded-none rounded-r-xl focus:ring-2 focus:ring-primary-500 focus:border-primary-500 focus:bg-white transition-all text-sm font-medium
                          @error('whatsapp') border-red-300 ring-red-100 @enderror">
                                ...
                                {{-- <div class="mb-4">
                                    ...
                                    <small class="text-gray-500 text-xs mt-1 block">Jika dicentang, potensi ini akan
                                ...
                                <div class="border-t pt-4 mt-6">
                                    <div class="flex justify-between items-center">
                                        ...
                                        <div class="flex gap-3">
                                            ...
                                            <!-- Simpan & Publikasikan -->
                                            <button type="submit" name="action" value="publish" class="px-5 py-2 bg-blue-600 text-white rounded-lg hover:bg-blue-700 transition
