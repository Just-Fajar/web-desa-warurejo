                            ...
                            <tr class="hover:bg-slate-50/50 transition-colors duration-150">
                                ...
                                <td class="px-6 py-4">
                                    <div class="flex items-center">
                                        <a href="{{ route('admin.publikasi.show', $item->id) }}"
                                            class="w-10 h-10 flex items-center justify-center bg-red-50 text-red-500 rounded-xl mr-4 shrink-0 shadow-sm border border-red-100 hover:opacity-80 transition-opacity">
                                            <i class="fas fa-file-pdf text-lg"></i>
                                        </a>
                                        <div>
                                            <div class="text-sm font-bold text-gray-800">
                                                <a href="{{ route('admin.publikasi.show', $item->id) }}" class="hover:text-primary-600 transition-colors">
