                ...
                <div class="bg-white rounded-lg shadow p-6">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
                        ...
                        <div>
                            ...
                            <input type="number" id="tahun" name="tahun" value="{{ old('tahun', $publikasi->tahun) }}" min="2000" max="{{ date('Y') + 5 }}" required
                ...
                <div class="bg-white rounded-lg shadow p-6">
                    ...
                    <div class="grid grid-cols-2 gap-y-4 gap-x-6 text-sm">
                        <div class="flex flex-col sm:flex-row sm:items-center justify-between border-b border-gray-100 pb-2">
                            ...
                            <span class="text-gray-800">{{ \Carbon\Carbon::parse($publikasi->created_at)->format('d M Y H:i') }}</span>
                        </div>
                        <div class="flex flex-col sm:flex-row sm:items-center justify-between border-b border-gray-100 pb-2">
                            <span class="text-gray-500 font-medium">Diupdate:</span> 
                            <span class="text-gray-800">{{ \Carbon\Carbon::parse($publikasi->updated_at)->format('d M Y H:i') }}</span>
                        </div>
                        <div class="flex flex-col sm:flex-row sm:items-center justify-between border-b border-gray-100 pb-2">
            ...
            <div class="lg:col-span-1 space-y-6">
                ...
                <div class="bg-white rounded-lg shadow p-6">
                    ...
                    <div class="mb-6">
                        ...
                        <div class="flex items-center p-3 bg-gray-50 rounded-lg mb-3">
                            ...
                            <div class="flex-1 overflow-hidden">
                                <p class="text-sm font-semibold text-gray-700 truncate">{{ basename($publikasi->file_dokumen) }}</p>
                                <p class="text-xs text-gray-500">File saat ini</p>
                            </div>
                            <a href="{{ $publikasi->file_url }}" target="_blank" class="text-primary-600 hover:text-primary-700 text-sm font-semibold whitespace-nowrap ml-2">
                                <i class="fas fa-eye mr-1"></i> Lihat
                            </a>
                        </div>
                        @endif
                        
                        <div class="border-2 border-dashed border-gray-300 rounded-lg p-6 text-center hover:border-primary-500 transition relative cursor-pointer">
                            <input type="file" id="file_dokumen" name="file_dokumen" accept=".pdf" class="absolute inset-0 w-full h-full opacity-0 cursor-pointer" onchange="displayFileName('file_dokumen', 'file-name')">
                            <i class="fas fa-file-pdf text-4xl text-gray-400 mb-3"></i>
                            <p class="text-primary-600 hover:text-primary-700 font-semibold text-sm">Pilih File PDF Baru</p>
                    ...
                    <div class="mb-4">
                        ...
                        <div class="border-2 border-dashed rounded-lg p-4 text-center relative hover:border-primary-400 transition cursor-pointer">
                            <input type="file" id="thumbnail" name="thumbnail" accept="image/jpeg,image/png,image/jpg,image/webp" class="absolute inset-0 w-full h-full opacity-0 cursor-pointer" onchange="previewThumbnail(event)">

                            <!-- Placeholder -->
                            <div id="thumbnailPlaceholder" class="{{ $publikasi->thumbnail ? 'hidden' : '' }}">
                                <i class="fas fa-image text-4xl text-gray-400 mb-3"></i>
                                <p class="text-primary-600 hover:text-primary-700 font-semibold text-sm">Pilih Gambar Baru</p>
                            ...
                            <div id="thumbnailPreviewContainer" class="{{ $publikasi->thumbnail ? '' : 'hidden' }}">
                                <img id="thumbnailPreview" src="{{ $publikasi->thumbnail ? $publikasi->thumbnail_url : '' }}" class="rounded-lg shadow w-full object-cover max-h-60">
                ...
                <div class="bg-white rounded-lg shadow p-6">
                    ...
                    <div class="mb-4">
                        ...
                        <input type="text" id="tanggal_publikasi" name="tanggal_publikasi" value="{{ old('tanggal_publikasi', $publikasi->tanggal_publikasi) }}"
                    ...
                    <!-- Submit Buttons -->
                    <button type="submit" class="w-full bg-primary-600 hover:bg-primary-700 text-white px-4 py-3 rounded-lg font-semibold transition duration-200">
                        Update Perubahan
                    </button>
                    
                    <div class="mt-3 text-center">
                        <a href="{{ route('admin.publikasi.index') }}" class="text-sm text-gray-500 hover:text-gray-700">
                            Batal
                        </a>
                    </div>
                </div>
