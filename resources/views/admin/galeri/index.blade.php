        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6" id="galeriGrid">
            @forelse($galeri as $item)
                <div class="bg-white rounded-3xl shadow-sm border border-gray-100 overflow-hidden galeri-item hover:-translate-y-1 hover:shadow-md transition-all duration-300 flex flex-col"
                    ...
                    <!-- Thumbnail -->
                    <div class="relative h-48 overflow-hidden bg-gray-50 shrink-0 group">
                        <!-- Checkbox -->
                        ...
                        @if($item->images && $item->images->count() > 0)
                            ...
                            @endif
                        @else
                            <a href="{{ route('admin.galeri.show', $item->id) }}" class="w-full h-full flex items-center justify-center border-b border-gray-100">
                    ...
                    <div class="p-5 flex-1 flex flex-col">
                        <h3 class="font-bold text-gray-800 text-sm mb-3 leading-tight">
                            <a href="{{ route('admin.galeri.show', $item->id) }}" class="hover:text-primary-600 transition-colors">
                    ...
                    <div class="p-3 border-t border-gray-50 bg-gray-50/50 flex gap-2">
                        <a href="{{ route('admin.galeri.show', $item->id) }}"
                            class="flex-1 flex items-center justify-center bg-emerald-50 text-emerald-600 hover:bg-emerald-500 hover:text-white py-2 rounded-xl text-xs font-medium transition-all duration-200"
                            title="Detail">
                        ...
                        <a href="{{ route('admin.galeri.edit', $item->id) }}"
                            class="flex-1 flex items-center justify-center bg-sky-50 text-sky-600 hover:bg-sky-500 hover:text-white py-2 rounded-xl text-xs font-medium transition-all duration-200"
                            title="Edit">
                            <svg class="w-4 h-4 mr-1" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                    d="M11 5H6a2 2 0 00-2 2v11a2 2 0 002 2h11a2 2 0 002-2v-5m-1.414-9.414a2 2 0 112.828 2.828L11.828 15H9v-2.828l8.586-8.586z" />
                        ...
                        <form action="{{ route('admin.galeri.destroy', $item->id) }}" method="POST" class="flex-1 delete-form">
                            ...
                            @method('DELETE')
                            <button type="submit"
                                class="w-full flex items-center justify-center bg-rose-50 text-rose-600 hover:bg-rose-500 hover:text-white py-2 rounded-xl text-xs font-medium transition-all duration-200">
                                <svg class="w-4 h-4 mr-1" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
