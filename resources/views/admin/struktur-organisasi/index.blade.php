        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
            <div
                ...
                <div
                    ...
                    <div
                        class="w-12 h-12 bg-blue-50/80 text-blue-600 rounded-2xl flex items-center justify-center shrink-0 border border-blue-100/50">
                ...
                <div
                    ...
                    <div>
                        ...
                        <h3 class="text-2xl font-black text-gray-800 mt-1">
                            {{ $strukturOrganisasi->whereIn('level', ['kepala', 'sekretaris'])->count() }}</h3>
                    </div>
                    <div
                        class="w-12 h-12 bg-amber-50/80 text-amber-600 rounded-2xl flex items-center justify-center shrink-0 border border-amber-100/50">
            ...
            <div
                ...
                <div
                    ...
                    <div>
                        ...
                        <h3 class="text-2xl font-black text-gray-800 mt-1">
                            {{ $strukturOrganisasi->whereIn('level', ['staff_kaur', 'staff_kasi'])->count() }}</h3>
                    </div>
                    <div
                        class="w-12 h-12 bg-purple-50/80 text-purple-600 rounded-2xl flex items-center justify-center shrink-0 border border-purple-100/50">
                        <svg class="w-6 h-6" fill="currentColor" viewBox="0 0 24 24">
                            <path
                                d="M14 14.252v2.091l-4-2V12.25L4 15.244v-3.085l6-2.992 4-2 6 2.99-6 2.99zm-4-4.887L6.002 11.36 10 13.355l3.998-1.996L10 9.365zM22 17v-4.148l-1.996 1V17H22zM12 2L2 6.99v4.06l10 4.981 10-4.981V6.99L12 2z" />
                        </svg>
                    </div>
                </div>
            </div>
                            ...
                            <tr class="hover:bg-slate-50/50 transition-colors duration-150" data-level="{{ $item->level }}">
                                ...
                                <td class="px-6 py-4 text-right text-sm font-medium">
                                    <div class="flex items-center justify-end gap-2">
                                        ...
                                        <form action="{{ route('admin.struktur-organisasi.destroy', $item->id) }}" method="POST"
                        ...
                        @empty
                            <tr>
                                <td colspan="6" class="px-6 py-12 text-center">
                                    ...
                                    <p class="mt-1 text-sm text-gray-500">Mulai dengan menambahkan anggota struktur organisasi
                                        baru.</p>
                                    <div class="mt-6">
                                        <a href="{{ route('admin.struktur-organisasi.create') }}"
