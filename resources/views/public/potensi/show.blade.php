                ...
                <article class="bg-white rounded-lg shadow-lg overflow-hidden mb-6 sm:mb-8">
                    ...
                    @if($potensi->gambar_url)
                        <div class="relative h-56 sm:h-64 md:h-80 lg:h-96 overflow-hidden">
                            <img src="{{ $potensi->gambar_url }}" alt="{{ $potensi->nama }}" class="w-full h-full object-cover">
                            ...
                            <div class="absolute top-3 sm:top-4 md:top-6 right-3 sm:right-4 md:right-6">
                                ...
                                @endphp
                                <span
                                    class="px-2.5 sm:px-3 md:px-4 py-1.5 sm:py-2 {{ $bgColor }} text-white text-xs sm:text-sm font-bold rounded-full uppercase shadow-lg">
                    ...
                    <div class="p-4 sm:p-6 md:p-8">
                        ...
                        <div class="mt-8 pt-8 border-t border-gray-200">
                            ...
                            <div class="flex flex-wrap gap-3">
                                <a href="https://www.facebook.com/sharer/sharer.php?u={{ urlencode(route('potensi.show', $potensi->slug)) }}"
                                    target="_blank"
                                ...
                                <a href="https://twitter.com/intent/tweet?url={{ urlencode(route('potensi.show', $potensi->slug)) }}&text={{ urlencode($potensi->nama) }}"
                                    target="_blank"
                                ...
                                <a href="https://wa.me/?text={{ urlencode($potensi->nama . ' - ' . route('potensi.show', $potensi->slug)) }}"
                                    target="_blank"
