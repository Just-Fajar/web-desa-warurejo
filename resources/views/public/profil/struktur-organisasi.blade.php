...
<section class="pt-32 pb-8 bg-gray-50 border-b border-gray-100 relative overflow-hidden">
    ...
    <div class="absolute top-0 right-0 -mt-20 -mr-20 w-80 h-80 bg-teal-100 rounded-full blur-3xl opacity-50 pointer-events-none"></div>
    <div class="absolute bottom-0 left-0 -mb-20 -ml-20 w-72 h-72 bg-teal-50 rounded-full blur-3xl opacity-50 pointer-events-none"></div>

    <div class="container mx-auto px-4 relative z-10">
        <div class="max-w-4xl scroll-reveal">
            <div class="inline-flex items-center gap-2 px-3 py-1.5 rounded-full bg-teal-100/80 text-teal-700 text-sm font-bold tracking-wide uppercase mb-4 border border-teal-200 shadow-sm">
    ...
    <div class="container mx-auto px-4 sm:px-6 lg:px-8 max-w-6xl">
        ...
        <div class="flex flex-col items-center justify-center mb-12 sm:mb-16 scroll-reveal">
            <div class="flex items-center gap-4 mb-6">
                ...
                <span class="text-primary-600 font-bold uppercase tracking-wider text-sm sm:text-base">Pemerintahan Desa</span>
                <div class="h-0.5 w-12 sm:w-16 bg-primary-600"></div>
            </div>
            ...
            <p class="text-gray-500 italic text-center max-w-3xl mx-auto text-base sm:text-lg md:text-xl leading-relaxed mt-2">
                "Disusun berdasarkan pedoman SOTK untuk memberikan pelayanan publik yang optimal, profesional, dan transparan."
            </p>
        </div>

        {{-- INFO BOX (Optional Minimalist) --}}
        <div class="bg-primary-50 rounded-2xl p-6 md:p-8 mb-12 sm:mb-16 border border-primary-100 scroll-reveal max-w-4xl mx-auto text-center">
            ...
            <p class="text-gray-600 text-sm sm:text-base leading-relaxed">
                Struktur organisasi perangkat Desa Warurejo disesuaikan dengan kebutuhan dan perkembangan daerah, berlandaskan prinsip gotong royong serta dedikasi untuk kesejahteraan bersama.
            </p>
        </div>
...
<div class="mb-10 sm:mb-16 scroll-reveal">
    @if(isset($struktur['kepala']) && $struktur['kepala'])
        <div class="max-w-md mx-auto relative group">
            <div class="absolute inset-0 bg-primary-600 rounded-2xl md:rounded-[2rem] transform translate-y-3 translate-x-3 group-hover:translate-y-4 group-hover:translate-x-4 transition-transform duration-300"></div>
            <div class="bg-white border border-gray-100 rounded-2xl md:rounded-[2rem] shadow-lg overflow-hidden relative z-10 transition duration-300">
                <div class="aspect-w-3 aspect-h-4 bg-gray-100 relative">
                    ...
                    <div class="absolute bottom-0 left-0 right-0 p-6 text-center text-white">
                        <div class="inline-block bg-primary-600 px-4 py-1.5 rounded-full text-xs font-bold uppercase tracking-wider mb-3">KEPALA DESA</div>
...
<div class="mb-10 sm:mb-16 scroll-reveal">
    @if(isset($struktur['sekretaris']) && $struktur['sekretaris'])
        <div class="max-w-sm mx-auto relative group">
            <div class="absolute inset-0 bg-green-600 rounded-2xl transform translate-y-2 translate-x-2 group-hover:translate-y-3 group-hover:translate-x-3 transition-transform duration-300"></div>
            <div class="bg-white border border-gray-100 rounded-2xl shadow-lg overflow-hidden relative z-10 transition duration-300">
                <div class="aspect-w-1 aspect-h-1 bg-gray-100 relative">
                    ...
                    <div class="absolute bottom-0 left-0 right-0 p-5 text-center text-white">
                        <div class="inline-block bg-green-600 px-3 py-1 rounded-full text-xs font-bold uppercase tracking-wider mb-2">SEKRETARIS DESA</div>
...
@endphp
@if($hasKaurOrKasi)
    <div class="hidden sm:block w-3/4 max-w-4xl mx-auto border-t-2 border-gray-200 h-8 transform -translate-y-2 relative">
        ...
        <div class="scroll-reveal">
            ...
            <div class="flex flex-col gap-6">
                @foreach($struktur['kaur'] as $kaur)
                    <div class="group bg-white rounded-2xl p-4 border border-gray-100 hover:border-yellow-200 hover:shadow-[0_8px_30px_rgb(0,0,0,0.08)] transition duration-300 flex items-center gap-4">
                        ...
                        <div>
                            <span class="inline-block px-2.5 py-0.5 bg-yellow-100 text-yellow-800 rounded text-[10px] font-bold uppercase tracking-wider mb-1.5">{{ $kaur->level_label }}</span>
                            <h4 class="font-bold text-gray-900 mb-0.5 text-base sm:text-lg group-hover:text-yellow-600 transition">{{ strtoupper($kaur->nama) }}</h4>
        ...
        <div class="scroll-reveal">
            ...
            <div class="flex flex-col gap-6">
                @foreach($struktur['kasi'] as $kasi)
                    <div class="group bg-white rounded-2xl p-4 border border-gray-100 hover:border-blue-200 hover:shadow-[0_8px_30px_rgb(0,0,0,0.08)] transition duration-300 flex items-center gap-4">
                        <div class="w-20 h-20 sm:w-24 sm:h-24 shrink-0 rounded-xl overflow-hidden bg-gray-100 relative">
                        ...
                        <div>
                            <span class="inline-block px-2.5 py-0.5 bg-blue-100 text-blue-800 rounded text-[10px] font-bold uppercase tracking-wider mb-1.5">{{ $kasi->level_label }}</span>
                            <h4 class="font-bold text-gray-900 mb-0.5 text-base sm:text-lg group-hover:text-blue-600 transition">{{ strtoupper($kasi->nama) }}</h4>
...
@if($hasStaff)
    <div class="mb-10 sm:mb-16 scroll-reveal mt-12 bg-gray-50/50 p-6 md:p-8 rounded-3xl border border-gray-100">
        <h3 class="text-lg sm:text-xl md:text-2xl font-bold text-gray-800 mb-8 text-center uppercase tracking-wider ">Staff Desa</h3>
        
        <div class="grid grid-cols-1 sm:grid-cols-2 gap-6 md:gap-8">
            {{-- Staff Kaur --}}
            @if(isset($struktur['staff_kaur']))
                @foreach($struktur['staff_kaur'] as $staff)
                    <div class="group bg-white rounded-2xl p-4 border border-gray-100 hover:border-gray-300 hover:shadow-[0_8px_30px_rgb(0,0,0,0.08)] transition duration-300 flex items-center gap-4">
                        <div class="w-20 h-20 sm:w-24 sm:h-24 shrink-0 rounded-xl overflow-hidden bg-gray-100 relative">
                        ...
                        <div>
                            <span class="inline-block px-2.5 py-0.5 bg-gray-100 text-gray-700 rounded text-[10px] font-bold uppercase tracking-wider mb-1.5">Staff</span>
                            <h4 class="font-bold text-gray-900 mb-0.5 text-base sm:text-lg group-hover:text-gray-600 transition">{{ strtoupper($staff->nama) }}</h4>
