        ...
        <div class="container mx-auto px-4 sm:px-6 lg:px-8 max-w-5xl">
            ...
            <div class="flex flex-col items-center justify-center mb-12 sm:mb-16 scroll-reveal">
                <div class="flex items-center gap-4 mb-6">
                    ...
                    <span class="text-primary-600 font-bold uppercase tracking-wider text-sm sm:text-base">Visi &
                        Misi</span>
                    <div class="h-0.5 w-12 sm:w-16 bg-primary-600"></div>
                </div>
                ...
                <h2
                    ...
                    "Menciptakan Desa Warurejo Menjadi Desa Yang Mandiri Berbasis Pertanian Dan Perdagangan Untuk Mencapai
            ...
            {{-- MISI CARD --}}
            <div
                class="bg-white rounded-2xl shadow-[0_8px_30px_rgb(0,0,0,0.06)] border border-gray-100 overflow-hidden scroll-reveal mb-12 sm:mb-16">
                ...
                <div class="p-6 sm:p-8">
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6 sm:gap-8">
                        ...
                        {{-- Item 9 --}}
                        <div
                            class="flex items-start gap-4 hover:-translate-y-1 md:col-span-2 lg:col-span-2 transition duration-300">
                            <div class="bg-primary-50 text-primary-600 p-1.5 sm:p-2 rounded-full shrink-0 mt-0.5">
                                <svg class="w-4 h-4 sm:w-5 sm:h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="3"
                                        d="M5 13l4 4L19 7" />
