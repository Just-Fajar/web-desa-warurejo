...
<section class="pt-32 pb-16 lg:pt-40 lg:pb-24 bg-gray-50 relative overflow-hidden">
    ...
    <div class="absolute top-0 right-0 -mt-20 -mr-20 w-80 h-80 bg-amber-100 rounded-full blur-3xl opacity-50 pointer-events-none"></div>
    <div class="absolute bottom-0 left-0 -mb-20 -ml-20 w-72 h-72 bg-amber-50 rounded-full blur-3xl opacity-50 pointer-events-none"></div>
    ...
    <div class="container mx-auto px-4 relative z-10">
        <div class="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-8 items-center max-w-7xl mx-auto">
            ...
            <div class="lg:col-span-5 scroll-reveal-left">
                <div class="inline-flex items-center gap-2 px-3 py-1.5 rounded-full bg-amber-100/80 text-amber-700 text-sm font-bold tracking-wide uppercase mb-6 border border-amber-200 shadow-sm">
                    <span class="w-1.5 h-1.5 rounded-full bg-amber-600 animate-pulse"></span>
                    HUBUNGI KAMI
                </div>
                
                <h1 class="text-4xl sm:text-5xl lg:text-6xl font-extrabold text-gray-900 mb-4 tracking-tight leading-tight">
                ...
                <p class="text-lg text-gray-600 mb-10 leading-relaxed font-medium">
                    Kami siap melayani kebutuhan administrasi warga pada jam kerja. Jangan ragu untuk menghubungi kami melalui kontak di bawah ini.
                </p>
            ...
            <div class="lg:col-span-7 h-full w-full scroll-reveal-right mt-12 lg:mt-0">
                <div class="bg-white p-3 rounded-[2rem] shadow-[0_20px_50px_-12px_rgba(0,0,0,0.1)] border border-gray-100 relative">
                    <div class="relative w-full h-[400px] md:h-[500px] lg:h-[600px] rounded-[1.5rem] overflow-hidden">
                        ...
                        <div class="absolute bottom-6 left-6 right-6 lg:left-auto lg:right-6 lg:w-72 bg-white/95 backdrop-blur-md p-4 rounded-xl shadow-lg border border-white">
                            ...
                            <a href="https://maps.app.goo.gl/G3PAkybFHZyfbzvC9?g_st=aw" target="_blank" class="block text-amber-600 text-xs font-semibold hover:text-amber-700 transition">
