            ...
            <div>
                ...
                <ul class="space-y-3 text-gray-400 text-sm">
                    ...
                    <li class="flex items-start">
                        ...
                        <a href="https://wa.me/62085168687700" target="_blank" class="hover:text-white transition">0851-6868-7700</a>
                    </li>
                    <li class="flex items-start">
                        <svg class="w-5 h-5 mr-2 text-primary-500 shrink-0" fill="currentColor" viewBox="0 0 20 20">
                        ...
                        <a href="mailto:desawarurejo@gmail.com" class="hover:text-white transition">desawarurejo@gmail.com</a>
                    </li>
                </ul>
                ...
                <ul class="space-y-2 text-gray-400 text-sm">
                    <li><a href="{{ route('publikasi.index', ['kategori' => 'APBDes']) }}" class="hover:text-white transition">APBDes</a></li>
                    <li><a href="{{ route('publikasi.index', ['kategori' => 'RPJMDes']) }}" class="hover:text-white transition">RPJMDes</a></li>
                    <li><a href="{{ route('publikasi.index', ['kategori' => 'RKPDes']) }}" class="hover:text-white transition">RKPDes</a></li>
                </ul>
            </div>
