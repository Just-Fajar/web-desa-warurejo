        ...
        <div class="flex justify-between items-center py-4">
            ...
            <button @click="mobileMenuOpen = !mobileMenuOpen" :class="scrolled ? 'text-gray-700' : 'text-white'"
                ...
                <svg class="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    ...
                    <path x-show="mobileMenuOpen" stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                        d="M6 18L18 6M6 6l12 12" class="transition-all duration-200" />
                </svg>
            </button>
        </div>
        ...
        <div x-show="mobileMenuOpen" x-transition:enter="transition ease-out duration-300"
            ...
            <div class="bg-white/95 backdrop-blur-lg rounded-xl shadow-2xl overflow-hidden border border-gray-100">
                <div class="max-h-[70vh] overflow-y-auto">
                    ...
                    <a href="{{ route('profil.visi-misi') }}" class="mobile-menu-item pl-10"
                        @click="mobileMenuOpen = false">
                        <span class="text-lg"></span>
                        Visi & Misi
                    </a>
                    <a href="{{ route('profil.sejarah') }}" class="mobile-menu-item pl-10"
                        @click="mobileMenuOpen = false">
                        <span class="text-lg"></span>
                        Sejarah
                    </a>
                    ...
                    <a href="{{ route('berita.index') }}" class="mobile-menu-item pl-10"
                        @click="mobileMenuOpen = false">
                        <span class="text-lg"></span>
                        Berita
                    </a>
                    <a href="{{ route('potensi.index') }}" class="mobile-menu-item pl-10"
                        @click="mobileMenuOpen = false">
                        <span class="text-lg"></span>
                        Potensi
                    </a>
                    <a href="{{ route('galeri.index') }}" class="mobile-menu-item pl-10"
                        @click="mobileMenuOpen = false">
                        <span class="text-lg"></span>
                        Dokumentasi
                    </a>
                    ...
                    <a href="{{ route('publikasi.index', ['kategori' => 'APBDes']) }}" class="mobile-menu-item pl-10"
                        @click="mobileMenuOpen = false">
                        <span class="text-lg"></span>
                        APBDes
                    </a>
                    <a href="{{ route('publikasi.index', ['kategori' => 'RPJMDes']) }}" class="mobile-menu-item pl-10"
                        @click="mobileMenuOpen = false">
                        <span class="text-lg"></span>
                        RPJMDes
                    </a>
                    <a href="{{ route('publikasi.index', ['kategori' => 'RKPDes']) }}" class="mobile-menu-item pl-10"
                        @click="mobileMenuOpen = false">
                        <span class="text-lg"></span>
                        RKPDes
                    </a>
