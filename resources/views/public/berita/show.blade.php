            ...
            if (btnShareInstagram) {
                btnShareInstagram.addEventListener('click', function(e) {
                    ...
                    if (navigator.share) {
                        navigator.share({
                            title: "{{ $berita->judul }}",
                            text: "Baca berita terbaru dari Desa Warurejo: {{ $berita->judul }}",
                        ...
                        navigator.clipboard.writeText(window.location.href)
                            .then(() => {
                                alert('Tautan berita ini berhasil tersalin ke clipboard! Silakan buka aplikasi Instagram Anda untuk membagikannya.');
                            })
                            .catch(err => {
