                    ...
                    <div class="flex flex-col md:flex-row md:items-center gap-4">
                        <div class="flex-1 grid grid-cols-1 md:grid-cols-3 gap-3">
                            <div class="relative">
                                ...
                                <input type="date" name="date_from" value="{{ request('date_from') }}" max="{{ date('Y-m-d') }}" class="w-full pl-10 pr-3 py-3 md:py-2.5 border border-gray-100 rounded-lg text-sm focus:ring-primary-500 focus:border-primary-500 bg-gray-50/70" title="Tanggal Mulai">
                            </div>
                            <div class="relative">
                                <div class="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none">
                                    <svg class="w-4 h-4 text-gray-400" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M8 7V3m8 4V3m-9 8h10M5 21h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v12a2 2 0 002 2z"/></svg>
                                </div>
                                <input type="date" name="date_to" value="{{ request('date_to') }}" max="{{ date('Y-m-d') }}" class="w-full pl-10 pr-3 py-3 md:py-2.5 border border-gray-100 rounded-lg text-sm focus:ring-primary-500 focus:border-primary-500 bg-gray-50/70" title="Tanggal Akhir">
                            </div>
                            <div class="relative">
                                <div class="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none">
                                ...
                                <select name="sort" class="w-full pl-10 pr-8 py-3 md:py-2.5 border border-gray-100 rounded-lg text-sm focus:ring-primary-500 focus:border-primary-500 bg-gray-50/70 appearance-none">
                        ...
                        <div class="bg-white rounded-2xl p-3 border border-gray-100 shadow-sm hover:shadow-xl hover:border-primary-100 transition-all duration-300 group flex flex-col scroll-reveal-stagger ring-1 ring-black/5 hover:ring-primary-500/20">
                            ...
                            <div class="px-2 pb-2 flex flex-col grow">
                                ...
                                <div class="flex items-center gap-2 mb-3">
                                    ...
                                    @if($item->admin)
                                        <span class="bg-gray-50 text-gray-500 px-2.5 py-1 rounded-md text-xs font-medium flex items-center gap-1.5 border border-gray-100 line-clamp-1 max-w-[120px]" title="Dipublikasikan oleh {{ $item->admin->name ?? $item->admin->username }}">
